...
В будущем планируется использовать ряд своего программного обеспечения. Например, я работаю над элементарной системой инициализации взамен использованию загрузочных скриптов. Кроме того, в будущем планируем написать свою автоматизированную [систему сборки (аналог ALFS)](https://github.com/Linux-for-ARM/bs).
